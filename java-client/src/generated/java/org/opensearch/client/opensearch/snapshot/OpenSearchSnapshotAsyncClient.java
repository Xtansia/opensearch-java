...
public class OpenSearchSnapshotAsyncClient extends ApiClient<OpenSearchTransport, OpenSearchSnapshotAsyncClient> {
     ...
     */
    public CompletableFuture<CloneSnapshotResponse> cloneSnapshot(CloneSnapshotRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CompletableFuture<CloneSnapshotResponse> cloneSnapshot(
     ...
     */
    public CompletableFuture<CreateSnapshotResponse> createSnapshot(CreateSnapshotRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CompletableFuture<CreateSnapshotResponse> createSnapshot(
     ...
     * Deletes a snapshot.
     */
    public CompletableFuture<DeleteSnapshotResponse> deleteSnapshot(DeleteSnapshotRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CompletableFuture<DeleteSnapshotResponse> deleteSnapshot(
     ...
     */
    public CompletableFuture<GetSnapshotResponse> getSnapshot(GetSnapshotRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CompletableFuture<GetSnapshotResponse> getSnapshot(
     ...
     */
    public CompletableFuture<SnapshotStatusResponse> snapshotStatus(SnapshotStatusRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CompletableFuture<SnapshotStatusResponse> snapshotStatus(
     ...
     * Returns information about the status of a snapshot.
     */
    public CompletableFuture<SnapshotStatusResponse> snapshotStatus() throws IOException, OpenSearchException {
        return this.transport.performRequestAsync(
