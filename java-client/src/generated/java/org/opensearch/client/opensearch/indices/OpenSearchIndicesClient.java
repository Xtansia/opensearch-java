...
public class OpenSearchIndicesClient extends ApiClient<OpenSearchTransport, OpenSearchIndicesClient> {
    ...
    // ----- Endpoint: indices.clone_index

    /**
     * Clones an index
     */
    public CloneIndexResponse cloneIndex(CloneIndexRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CloneIndexResponse cloneIndex(Function<CloneIndexRequest.Builder, ObjectBuilder<CloneIndexRequest>> fn) throws IOException,
        OpenSearchException {
        return cloneIndex(fn.apply(new CloneIndexRequest.Builder()).build());
    }

    // ----- Endpoint: indices.close_index

    /**
     * Closes an index.
     */
    public CloseIndexResponse closeIndex(CloseIndexRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CloseIndexResponse closeIndex(Function<CloseIndexRequest.Builder, ObjectBuilder<CloseIndexRequest>> fn) throws IOException,
        OpenSearchException {
        return closeIndex(fn.apply(new CloseIndexRequest.Builder()).build());
    }
    ...
    // ----- Endpoint: indices.create_index

    /**
     * Creates an index with optional settings and mappings.
     */
    public CreateIndexResponse createIndex(CreateIndexRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final CreateIndexResponse createIndex(Function<CreateIndexRequest.Builder, ObjectBuilder<CreateIndexRequest>> fn)
        throws IOException, OpenSearchException {
        return createIndex(fn.apply(new CreateIndexRequest.Builder()).build());
    }
    ...
    // ----- Endpoint: indices.delete_index

    /**
     * Deletes an index.
     */
    public DeleteIndexResponse deleteIndex(DeleteIndexRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final DeleteIndexResponse deleteIndex(Function<DeleteIndexRequest.Builder, ObjectBuilder<DeleteIndexRequest>> fn)
        throws IOException, OpenSearchException {
     ...
     * Analyzes the disk usage of each field of an index or data stream
     *
     * @param fn a function that initializes a builder to create the {@link DiskUsageRequest}
     */
     ...
     * Returns mapping for one or more fields.
     *
     * @param fn a function that initializes a builder to create the {@link GetFieldMappingRequest}
     */
    ...
    // ----- Endpoint: indices.get_index

    /**
     * Returns information about one or more indices.
     */
    public GetIndexResponse getIndex(GetIndexRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final GetIndexResponse getIndex(Function<GetIndexRequest.Builder, ObjectBuilder<GetIndexRequest>> fn) throws IOException,
        OpenSearchException {
        return getIndex(fn.apply(new GetIndexRequest.Builder()).build());
    }
    ...
    // ----- Endpoint: indices.get_indices_settings

    /**
     * Returns settings for one or more indices.
     */
    public GetIndicesSettingsResponse getIndicesSettings(GetIndicesSettingsRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final GetIndicesSettingsResponse getIndicesSettings(
        Function<GetIndicesSettingsRequest.Builder, ObjectBuilder<GetIndicesSettingsRequest>> fn
    ) throws IOException, OpenSearchException {
        return getIndicesSettings(fn.apply(new GetIndicesSettingsRequest.Builder()).build());
    }

    /**
     * Returns settings for one or more indices.
     */
    public GetIndicesSettingsResponse getIndicesSettings() throws IOException, OpenSearchException {
        return this.transport.performRequest(
    ...
    // ----- Endpoint: indices.indices_stats

    /**
     * Provides statistics on operations happening in an index.
     */
    public IndicesStatsResponse indicesStats(IndicesStatsRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final IndicesStatsResponse indicesStats(Function<IndicesStatsRequest.Builder, ObjectBuilder<IndicesStatsRequest>> fn)
        throws IOException, OpenSearchException {
        return indicesStats(fn.apply(new IndicesStatsRequest.Builder()).build());
    }

    /**
     * Provides statistics on operations happening in an index.
     */
    public IndicesStatsResponse indicesStats() throws IOException, OpenSearchException {
        return this.transport.performRequest(
    ...
    // ----- Endpoint: indices.put_indices_settings

    /**
     * Updates the index settings.
     */
    public PutIndicesSettingsResponse putIndicesSettings(PutIndicesSettingsRequest request) throws IOException, OpenSearchException {
        @SuppressWarnings("unchecked")
     ...
     */
    public final PutIndicesSettingsResponse putIndicesSettings(
        Function<PutIndicesSettingsRequest.Builder, ObjectBuilder<PutIndicesSettingsRequest>> fn
    ) throws IOException, OpenSearchException {
        return putIndicesSettings(fn.apply(new PutIndicesSettingsRequest.Builder()).build());
    }
